...
if(args.euler):
    ...
    dataset_path_train='/hdd/eli/ycb_mult_1_thousand_seq/train'
    dataset_path_val='/hdd/eli/ycb_mult_1_thousand_seq/val' 
    folder='/hdd/eli/auto2018_1024dim_3000points_NoAug_1000seq_scissor'
else:
    dataset_path_train='/home/elham/Desktop/makeDataset/warping/warping_shapes_generation/build_path/ycb_mult_1_thousand_seq/train'
    dataset_path_val='/home/elham/Desktop/makeDataset/warping/warping_shapes_generation/build_path/ycb_mult_1_thousand_seq/val'
    folder='../auto2018_1024dim_3000points_NoAug_1000seq_scissor' 
    if torch.cuda.is_available():
